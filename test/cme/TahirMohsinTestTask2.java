...
class TahirMohsinTestTask2 {
    ...
    @Test
    public void testInvalidNormalPeriod() {
        BigDecimal normalRate = BigDecimal.valueOf(10);
        BigDecimal reducedRate = BigDecimal.valueOf(3);
        CarParkKind kind = CarParkKind.STAFF;
        ArrayList<Period> normalPeriods = new ArrayList<>();
        normalPeriods.add(new Period(11, 10));
        ArrayList<Period> reducedPeriods = new ArrayList<>();
        reducedPeriods.add(new Period(8, 12));
        assertThrows(IllegalArgumentException.class, () -> {
            Rate rate = new Rate(normalRate, reducedRate, kind, reducedPeriods, normalPeriods);
    ...
    @Test
    public void testInvalidReducedPeriod() {
        BigDecimal normalRate = BigDecimal.valueOf(9.9);
        BigDecimal reducedRate = BigDecimal.valueOf(1.5);
        CarParkKind kind = CarParkKind.MANAGEMENT;
        ArrayList<Period> normalPeriods = new ArrayList<>();
        normalPeriods.add(new Period(10, 11));
        ArrayList<Period> reducedPeriods = new ArrayList<>();
        reducedPeriods.add(new Period(9, 5));
        assertThrows(IllegalArgumentException.class, () -> {
            Rate rate = new Rate(normalRate, reducedRate, kind, reducedPeriods, normalPeriods);
        });
    }
    ...
    @Test
    public void testMaxDecimalValueReducedRate() {
    ...
    @Test
    public void testMinDecimalValueReducedRate() {
    ...
    @Test
    public void testIncorrectCarParkKind() {
        BigDecimal normalRate = BigDecimal.valueOf(1);
        BigDecimal reducedRate = BigDecimal.valueOf(0.1);
        CarParkKind kind = CarParkKind.valueOf("UNDEFINED");
        ArrayList<Period> normalPeriods = new ArrayList<>();
        normalPeriods.add(new Period(5, 8));
        ArrayList<Period> reducedPeriods = new ArrayList<>();
        reducedPeriods.add(new Period(12, 16));
